...
export function LoginForm({ inviteCode, onSuccess }: LoginFormProps) {
      ...
      {inviteCode && (
        <div className="pt-2">
          <p className="text-xs text-center text-muted-foreground">
            邀请码：<code className="px-1.5 py-0.5 bg-muted rounded font-mono text-primary">{inviteCode}</code>
          </p>
        </div>
      )}
    </div>
